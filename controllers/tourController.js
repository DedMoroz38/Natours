...
const multerFilter = (req, file, cb) => {
    cb(null, true);
    // console.log(file.mimetype.startsWith('multipart'));
    // if (file.mimetype.startsWith('multipart')){
    //     cb(null, true);
    // } else {
...
//     if(!tour) {
//         return next(new AppErrors('No tour found!', 404));
//     }
...
exports.getToursWithin = catchAsync( async (req, res, next) => {
    ...
    if(!lat || !lng){
        return next(new AppErrors("Please provide latitude and longitude in the format lat,lng.", 400));
    }
