      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", "Error with logging out( Try again!");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _axios.default.patch("http://localhost:9000/api/v1/users/".concat(url), data).then(function (res) {
              if (res.data.status === "success") {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/alerts/index.js":[function(require,module,exports) {
var initialized;
...
var stripe = Stripe("pk_test_51L8USXGeQbmtkKIdCgrjwteiVT7DIVEVK552zq99m5h4CC47XBm8veOMATU240vQOUEDc3LT60UosocytwCP7vEA00aLZYcu9s");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:9000/api/v1/booking/checkout-session/".concat(tourId));

          case 3:
            session = _context.sent;
            location.replace("".concat(session.data.session.url));
...
},{"axios":"../../node_modules/axios/index.js","alerts":"../../node_modules/alerts/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (passwordForm) {
  passwordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var updateButton, passwordCurrent, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              updateButton = document.querySelector(".btn--password-update");
